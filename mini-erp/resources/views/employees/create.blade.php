...
<head>
    ...
    <title>إضافة موظف جديد | ERP</title>
        ...
        <main class="flex-1 overflow-y-auto h-screen bg-gray-50">
            ...
            <header class="h-20 border-b border-gray-200 bg-white flex items-center justify-between px-8 sticky top-0 z-10 shadow-sm">
                <div class="flex items-center gap-4">
                    <h2 class="text-xl font-bold text-gray-800">إضافة موظف</h2>
                </div>
            ...
            <div class="p-6 md:p-10 max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    <div class="p-6 border-b border-gray-100 bg-gray-50">
                        <h3 class="text-lg font-bold text-gray-900">بيانات الموظف الجديد</h3>
                        <p class="text-sm text-gray-500 mt-1">يرجى تعبئة جميع الحقول المطلوبة بدقة</p>
                    </div>

                    <form action="{{ route('employees.store') }}" method="POST" class="p-6 md:p-8 space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-all outline-none" placeholder="مثال: محمد أحمد" required>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-all outline-none" placeholder="name@company.com" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="password" name="password" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-all outline-none" placeholder="••••••••" required>
                            ...
                            <div>
                                ...
                                <input type="number" name="salary" value="{{ old('salary') }}" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-all outline-none" placeholder="0.00">
                            </div>
                        </div>
